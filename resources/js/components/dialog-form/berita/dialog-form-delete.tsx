        ...
        <AlertDialog open={open} onOpenChange={setOpen}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Ini akan menghapus berita <span className="font-bold">{data.judul}</span> secara permanen dan tidak dapat dikembalikan.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    <AlertDialogCancel>Tidak</AlertDialogCancel>
                    <Form {...BeritaController.destroy.form(data.id)} className='w-full sm:w-auto'>
                        <AlertDialogAction
                            type="submit"
